import customtkinter, tkinter.messagebox, pickle, typing, My_Organizer_settings_interface
...
class My_Organizer_setting_window(customtkinter.CTkToplevel, My_Organizer_settings_interface.My_Organizer_setting_window_interface):
    ...
    def __language_settings__(self: typing.Self, pickle_serializer: pickle) -> None:
        ...
        with open(f"my_organizer_language_settings.pickle", f"wb+") as self.data:
    ...
    def __theme_settings__(self: typing.Self, pickle_serializer: pickle) -> None:
        ...
        with open(f"my_organizer_theme_settings.pickle", f"wb+") as self.data:
